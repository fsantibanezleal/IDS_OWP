function stDummy = TIPS_PreCalc(im_T,stParams,mfile,BaseName)
...
%% End of current block size analysis, then add substructure 
        eval(['mfile.' ...
               ...
               '= dummyPatternInfo;']);
        myPatternInfo = dummyPatternInfo;
        save( [BaseName '__' stParams.namePDF 'stSize_' num2str(idxPS) '.mat'],'myPatternInfo','-v7.3')
