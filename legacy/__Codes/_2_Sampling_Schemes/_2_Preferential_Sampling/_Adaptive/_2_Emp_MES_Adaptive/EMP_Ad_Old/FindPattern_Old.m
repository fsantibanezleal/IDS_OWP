function  patternSearch = FindPattern_Old(idxP,stParams )
...
[idxI,idxJ] = ind2sub(stParams.dimIT,idxP);
% Available positions
...
limits.lbMask.max.x = min(idxI + widthMask , stParams.dimIT(1));
limits.lbMask.max.y = min(idxJ + widthMask , stParams.dimIT(2));
