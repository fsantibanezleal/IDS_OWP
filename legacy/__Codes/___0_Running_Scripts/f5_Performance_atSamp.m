function varargout = f5_Performance_atSamp(varargin)
% f5_Performance_atSamp_atSamp MATLAB code for f5_Performance_atSamp_atSamp.fig
%      f5_Performance_atSamp, by itself, creates a new f5_Performance_atSamp or raises the existing
%      singleton*.
%
%      H = f5_Performance_atSamp returns the handle to a new f5_Performance_atSamp or the handle to
%      the existing singleton*.
%
%      f5_Performance_atSamp('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in f5_Performance_atSamp.M with the given input arguments.
%
%      f5_Performance_atSamp('Property','Value',...) creates a new f5_Performance_atSamp or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before f5_Performance_atSamp_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to f5_Performance_atSamp_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help f5_Performance_atSamp
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @f5_Performance_atSamp_OpeningFcn, ...
                   'gui_OutputFcn',  @f5_Performance_atSamp_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before f5_Performance_atSamp is made visible.
function f5_Performance_atSamp_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to f5_Performance_atSamp (see VARARGIN)
...
% Choose default command line output for f5_Performance_atSamp
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes f5_Performance_atSamp wait for user response (see UIRESUME)
       ...
       (numel(strfind(filesSamp(idxSP).name, '.mat')) > 0) && ...
        ...
        %for idxIterS = nSamples
            ...
            plotAxes(HD,simsM,...
                     ...
                     handles.hSS2_Std,handles.hSS2_Ent,...
                     handles.hSS2_Iso,...
                     handles,...
            ...
            plotAxes(HD,simsM,...
                     handles.hSS3_Samples,handles.hSS3_Mean,...
                     handles.hSS3_Std,handles.hSS3_Ent,...
                     handles.hSS3_Iso,...
                     handles,...
                     filesModels(idxM).name,'Rand_Strat',levelS);
            ...
            plotAxes(HD,simsM,...
                     handles.hSS4_Samples,handles.hSS4_Mean,...
                     handles.hSS4_Std,handles.hSS4_Ent,...
                     handles.hSS4_Iso,...
                     handles,...
                     filesModels(idxM).name,'Multi_Strat',levelS);
            ...
            plotAxes(HD,simsM,...
                     ...
                     handles.hSS5_Std,handles.hSS5_Ent,...
                     handles.hSS5_Iso,...
                     handles,...
            ...
            plotAxes(HD,simsM,...
                     ...
                     handles.hSS6_Std,handles.hSS6_Ent,...
                     handles.hSS6_Iso,...
                     handles,...
            ...
            plotAxes(HD,simsM,...
                     ...
                     handles.hSS7_Std,handles.hSS7_Ent,...
                     handles.hSS7_Iso,...
                     handles,...
...
function plotAxes(imSampled,simsM,hAxes_Samples,hAxes_Mean,hAxes_Std,hAxes_Ent,hAxes_Iso,handles, modelS,SamplingScheme,levelS)
% PLot mean
axes(hAxes_Samples);
axis off;
imagesc(imSampled);
...
function varargout = f5_Performance_atSamp_OutputFcn(hObject, eventdata, handles) 
